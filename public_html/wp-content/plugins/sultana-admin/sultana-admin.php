...
require_once SULTANA_ADMIN_PATH . 'src/Media/MediaImageProcessor.php';
...
require_once SULTANA_ADMIN_PATH . 'src/Promotions/PromotionImageService.php';
require_once SULTANA_ADMIN_PATH . 'src/Promotions/PromotionService.php';
require_once SULTANA_ADMIN_PATH . 'src/Promotions/PromotionController.php';
...
require_once SULTANA_ADMIN_PATH . 'src/Reviews/ReviewService.php';
require_once SULTANA_ADMIN_PATH . 'src/Reviews/ReviewController.php';
